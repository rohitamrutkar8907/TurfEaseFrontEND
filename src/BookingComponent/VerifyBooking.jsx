...
const VerifyBooking = () => {
  ...
  const retrieveAllBookingStatus = async () => {
    const response = await axios.get(
      `${config.server}/api/book/ground/fetch/status`
    );
  ...
  const retrieveBooking = async () => {
    const response = await axios.get(
     `${config.server}/api/book/ground/fetch/bookingId?id=` + bookingId
    );
  ...
  const updateGroundBookingStatus = (e) => {
    ...
    fetch(`${config.server}/api/book/ground/update/status`, {
      method: "POST",
      headers: {
      ...
      <div className="mt-2 d-flex aligns-items-center justify-content-center mb-5">
        ...
        >
          ...
          <div className="card-body text-color">
            <div>
              <img
                src={`${config.server}/api/ground/` + booking.groundImage}
                class="img-fluid"
                alt="ground_img"
              ></img>
            </div>
